  ...
  useEffect(() => {
    ...
    if (dataFetched) {
      ...
      if (warehouse) {
        ...
        setErrorMessage(
          "Warehouse not found. Redirecting to warehouses page..."
        );
        setTimeout(() => {
          navigate("/warehouses");
        }, 3000);
      ...
      <section className="edit-warehouse">
        <div className="edit-warehouse__title">
          <Link to={`/warehouses/${formData.id}`}>
            <img
              className="edit-warehouse__title-icon"
              src={ArrowBack}
              alt="Arrow Back for Edit"
            />
          </Link>
          ...
          <form onSubmit={handleSave} className="edit-warehouse__form">
            <div className="edit-warehouse__form-input-wrapper">
              <div className="edit-warehouse__form-group-one">
                <h2 className="edit-warehouse__form-group-one-subtitle">
                  Warehouse Details
                </h2>
                <label
                  htmlFor="warehouse_name"
                  className="edit-warehouse__form-group-one-label"
                >
                  Warehouse Name
                </label>
                <input
              ...
              <div className="edit-warehouse__form-group-two">
                <h2 className="edit-warehouse__form-group-two-subtitle">
                  Contact Details
                </h2>
                <label
                  htmlFor="contact_name"
                  className="edit-warehouse__form-group-two-label"
                >
                  Contact Name
                </label>
                <input
