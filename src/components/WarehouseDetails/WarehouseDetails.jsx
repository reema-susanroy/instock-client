    ...
    <div className="warehouse_details">
      <div className="warehouse_details__header-cont">
        ...
        <div className="warehouse_details__header-edit">
          <Link
            to={`/warehouses/${currentData.id}/edit`}
            className="warehouse_details__header-edit-cont"
          >
            <img
              className="warehouse_details__header--edit"
              src={edit}
              alt="edit"
            />{" "}
            <span className="warehouse_details__header--edit__span">Edit</span>
          </Link>
        </div>
      </div>
      <div className="warehouse_details__content-cont">
        <div className="warehouse_details__content--address">
          ...
          <div className="warehouse_details__content--address-data">
            <p className="warehouse-details-content"> {`${currentData.address}, ${currentData.city}, ${currentData.country}`}</p>
          </div>
        </div>
        <div className="warehouse_details__content--contact">
          <div>
            <h4 className="warehouse_details__content--label">CONTACT NAME:</h4>
            <p className="warehouse-details-content">{currentData.contact_name}</p>
            <p className="warehouse-details-content">{currentData.contact_position}</p>
          </div>
          <div>
            <h4 className="warehouse_details__content--label">
              CONTACT INFORMATION:
            </h4>
            <p className="warehouse-details-content">{currentData.contact_phone}</p>
            <p className="warehouse-details-content">{currentData.contact_email}</p>
          </div>
        </div>
      </div>
    </div>
